...
void listRetainAll(ArrayList **listPtr, const ArrayList *toRetain,
...
void listRemoveElement(ArrayList **listPtr, const void *toRemove,
                       EqualityFunction compare);
// Removes elements from the ArrayList within the specified range from the start
...
// Removes all occurrences of elements from another ArrayList from the current
// ArrayList based on a specified comparison function.
void listRemoveAll(ArrayList **listPtr, const ArrayList *toRemove,
                   EqualityFunction compare);
...
// Returns true if the specified element exists in the ArrayList; otherwise,
// returns false.
bool listContains(const ArrayList *list, const void *toFind,
                  EqualityFunction compare);
// Returns the index of the first occurrence of the specified element in the
// ArrayList.
int listIndexOf(const ArrayList *list, const void *toFind,
                EqualityFunction compare);
// Returns the index of the last occurrence of the specified element in the
// ArrayList.
int listLastIndexOf(const ArrayList *list, const void *toFind,
                    EqualityFunction compare);
